  ...
  return (
    <nav className="fixed top-0 right-0 left-0 md:left-64 h-16 bg-white border-b border-border flex items-center px-4 md:px-6 shadow-sm transition-all">
      ...
      <div className="ml-auto flex items-center gap-4 md:gap-6">
        ...
        {/* Logout Button */}
        <button onClick={() => window.location.href = "/"} className="flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg border border-accent text-accent hover:bg-accent hover:text-accent-foreground transition-colors font-medium text-xs md:text-sm">
          <LogOut size={16} />
